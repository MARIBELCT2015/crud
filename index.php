...
<body>
    ...
    <h1 class="text-center mt-5 mb-5 fw-bold">CRUD Base de datos empleados PHP, MySQL y Bootstrap 5.</h1>
    <h2 class="text-center mt-5 mb-5 fw-bold">Maribel Cifuentes ADSO 2834929</h2>
    <div class="container">
